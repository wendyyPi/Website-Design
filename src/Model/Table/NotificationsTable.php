...
class NotificationsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('notif_description')
            ->maxLength('notif_description', 256)
            ->requirePresence('notif_description', 'create')
            ->notEmptyString('notif_description');

        $validator
            ->scalar('notif_isRead')
            ->requirePresence('notif_isRead', 'create')
            ->notEmptyString('notif_isRead');

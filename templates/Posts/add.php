 ...
 *
 */
echo $this->Html->script("https://cdn.ckeditor.com/ckeditor5/34.0.0/classic/ckeditor.js",['block'=>true]);
?>
        ...
        <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
                ...
                <div class="col-12 col-xl-auto mb-3">
                    <?= $this->Html->link(__('Back to All Posts'),['action' => 'index'],
...
<fieldset>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <?=$this->Form->control('post_title',['class'=>"form-control", 'label' => ''])  ?> </div>
    </div>

    <div class="card mb-4">
        <div class="card-header">Post Content</div>
        <div class="card-body">
            <?= $this->Form->control('post_content',['class'=>'form-control','label'=>'']) ?>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <?= $this->Form->control('tag_id',['options' => $tags,'label'=>''])?>
        </div>
    </div>
